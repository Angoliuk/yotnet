...
function InputsWithUserData(props) {
    ...
    return(
        <div>
            ...
            <img onClick={onChangeAvatar} title="click to choose new avatar" className="chosenAvatar" alt='avatar' src={stateForInputs.avatar} />
            ...
            ?   Modal(
                    <div className="avatarModalBlock">
                        {avatarLinks.map((avatar, i) => {
                            return(
                                <div key={i}>
                                    <img onClick={onChangeAvatar} name='avatar' id={`avatar${i}`} className="avatarImg" src={avatar} alt="avatar pic" />
                                </div>
                            )
                        })}
                    </div> 
